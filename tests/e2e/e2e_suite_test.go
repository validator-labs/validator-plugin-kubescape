...
var (
	...
	projectImage = "quay.io/validator-labs/validator-plugin-kubescape:latest"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting validator-plugin-kubescape integration test suite\n")
